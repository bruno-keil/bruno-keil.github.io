...
export function reset(t1_hits, t2_hits) {
    ...
    messageContainer.appendChild(scoreboard1); 
    messageContainer.appendChild(scoreboard2);

    // Append container to body
    document.body.appendChild(messageContainer);

    // Clear the displayed messages after 5 seconds
    setTimeout(() => {
...
export function resetl() {
    // Store the current selected level in localStorage
