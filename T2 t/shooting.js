...
const t1HitsElement = document.createElement('div');
t1HitsElement.id = 't1-hits';
t1HitsElement.style.position = 'absolute';
t1HitsElement.style.top = '10px';
t1HitsElement.style.left = '10px';
t1HitsElement.style.color = '#ffffff'; // Set text color to white
t1HitsElement.style.fontWeight = 'bold'; // Make the text bold
document.body.appendChild(t1HitsElement);

const t2HitsElement = document.createElement('div');
t2HitsElement.id = 't2-hits';
t2HitsElement.style.position = 'absolute';
t2HitsElement.style.top = '30px';
t2HitsElement.style.left = '10px';
t2HitsElement.style.color = '#ffffff'; // Set text color to white
t2HitsElement.style.fontWeight = 'bold'; // Make the text bold
document.body.appendChild(t2HitsElement);

t1HitsElement.textContent = `Tank1: ${t2_hits}`;
t2HitsElement.textContent = `Tank2: ${t1_hits}`;
