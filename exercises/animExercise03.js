...
var cylinderMaterial3 = new THREE.MeshLambertMaterial( {color:'rgb(255,255,0)'} );
...
var cylinderMaterial4 = new THREE.MeshLambertMaterial( {color:'rgb(255,255,0)'} );
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder3.matrix.multiply(mat4.makeRotationY(-angle)); // R1
    ...
    cylinder4.matrix.multiply(mat4.makeRotationY(angle)); // R1
