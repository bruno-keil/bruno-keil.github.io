...
function keyboardUpdate() {
   ...
   if (keyboard.pressed("up")) camera.position.y += 1;
   if (keyboard.pressed("down")) camera.position.y -= 1;
   if (keyboard.pressed("pageup")) camera.position.z -= 1;
   if (keyboard.pressed("pagedown")) camera.position.z += 1;

   if (keyboard.pressed("A")) camLook.x -= 1;
   if (keyboard.pressed("D")) camLook.x += 1;
   if (keyboard.pressed("W")) camLook.z -= 1;
   if (keyboard.pressed("S")) camLook.z += 1;
   if (keyboard.pressed("Q")) camLook.y -= 1;
   if (keyboard.pressed("E")) camLook.y += 1;
